...
export default function DocumentationSection({
  ...
  return (
    <Card type="default" className="flex flex-col w-full gap-4 max-w-[550px]">
      ...
      <p className="text-white/70 text-sm pl-3">
        Pour se connecter, utilisez l'accès à votre compte google de
        l'entreprise dont les accès sont disponibles dans la section "Mes accès"
