...
function addChildToNode(
  ...
  return {
    ...
    children: node.children.map((existing) =>
      addChildToNode(existing, parentId, child)
    ),
  };
}
...
export default function OrganigrammePage() {
  ...
  const handleSaveNode = useCallback(async () => {
    ...
    const parsedCount = trimmedCount
      ? Number.parseInt(trimmedCount, 10)
      : undefined;
    const safeCount =
  ...
  return (
    <section className="relative flex min-h-screen w-full flex-col items-center gap-8 bg-noir">
      ...
      >
        <DialogContent className="max-w-3xl border-white/10 bg-[#13162F] text-white">
          <DialogHeader>
            <div className="flex items-center gap-4">
              <Avatar
                src={selectedNode?.image ?? null}
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    <div className="flex-1 space-y-3">
                      ...
                      <Button
                        ...
                        className="w-full rounded-full bg-violet_fonce_1 px-4 py-2 text-sm font-semibold text-white transition hover:bg-violet md:w-fit"
                      >
                        Enregistrer
                      </Button>
                    </div>
            ...
            <div className="flex w-full items-center justify-between">
              {selectedNode && selectedNode.id !== treeData.id ? (
                <Button
                  ...
                  className="text-white bg-red-600 hover:bg-red-500 hover:text-white border-0"
                >
                  Supprimer ce noeud
                </Button>
              ) : (
